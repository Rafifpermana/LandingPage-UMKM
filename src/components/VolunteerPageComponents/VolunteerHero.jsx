...
export default function VolunteerHero() {
  return (
    <section className="relative bg-gradient-to-r from-emerald-500 to-green-600 text-white h-96 lg:h-[550px] flex items-center overflow-hidden">
      <div className="container mx-auto px-4 z-10 relative">
        <h1 className="text-4xl lg:text-5xl font-bold mb-3">
          Jadi Relawan UMKM Hebat
        </h1>
        <p className="text-lg text-green-100 max-w-xl">
          Sumbangkan waktu dan keahlianmu untuk memberikan dampak positif bagi
