...
export default function TrainingHero() {
  return (
    <section className="relative bg-gradient-to-r from-green-500 to-emerald-600 text-white h-96 lg:h-[550px] flex items-center overflow-hidden">
      <div className="container mx-auto px-4 z-10 relative">
        <h1 className="text-4xl lg:text-5xl font-bold mb-3">
          Training UMKM Hebat
        </h1>
        <p className="text-lg text-emerald-100 max-w-xl">
          Asah keterampilan praktis dan tingkatkan skala bisnismu bersama
