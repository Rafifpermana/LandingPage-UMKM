    ...
    <section className="py-16 lg:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-5xl mx-auto aspect-video overflow-hidden rounded-2xl shadow-lg">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/50 p-2 rounded-full transition text-white opacity-0 group-hover:opacity-100 duration-300 z-10"
          >
            <ChevronLeft size={24} />
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/50 p-2 rounded-full transition text-white opacity-0 group-hover:opacity-100 duration-300 z-10"
          >
