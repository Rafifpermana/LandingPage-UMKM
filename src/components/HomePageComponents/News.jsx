...
const news = [
  {
    ...
    img: "bg-gradient-to-br from-green-400 to-green-600",
  },
  {
    ...
    category: "BLOG",
    excerpt:
      "Halo Sobat Hebat! Tau kan kalau dunia bisnis saat ini semakin kompetitif? Oleh karena itu, Branding menjadi faktor...",
  ...
  },
  {
    ...
    category: "BLOG",
    excerpt:
      "Hai Sobat Hebat, Siapa yang bingung gimana cara mencatat keuangan usaha? Atau...",
